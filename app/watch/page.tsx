...
export default function LiveStreamPage() {
  ...
  return (
    <>
      <MetaTags title="Watch – InnerCity Mission HQ" />
      <div className="bg-white py-6">
        ...
        <div className="wrapper mt-6 grid grid-cols-12 gap-6">
          <div className="col-span-12 flex flex-col gap-4 md:col-span-7 lg:col-span-8">
            <VideoPlayer
              src={
                'https://d1ent1.loveworldcloud.com/~lwconcepts//CMD%20ON%20TRSMI/HSLHS%20VIDEO%20PODCAST%20WITH%20PASTOR%20T%20T%20-%20FOR%20NETWORKS%20-%20PAL2.mp4'
            ...
            />
            <h4 className="ellipsis-2 text-xl font-bold uppercase md:text-2xl">HSLHS PODCAST</h4>
          </div>
