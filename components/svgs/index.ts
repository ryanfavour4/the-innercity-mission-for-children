...
export { default as EmailEnvelopeOutlineIcon } from '@/public/assets/svg/email-envelope-outline.svg'
export { default as PhoneCallOutlineIcon } from '@/public/assets/svg/phone-call-outline.svg'
